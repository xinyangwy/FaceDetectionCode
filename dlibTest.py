...
# https://www.jb51.net/article/135512.htm?utm_medium=referral
...
# face_recognition_resnet_model_path  = dlib.shape_predictor('dlib_face_recognition_resnet_model_v1.dat')
